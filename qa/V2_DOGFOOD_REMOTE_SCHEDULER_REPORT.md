...
| Candidate implementation SHA | `fc5c5d1d8bcc15762ec3bd22124d0dc8a77900b5` |
| Candidate branch tip | `feat/v2-remote-scheduler-dogfood-01` (docs commits may follow; use `git rev-parse HEAD` in the worktree) |
